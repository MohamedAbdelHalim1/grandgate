    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                {{-- Blogs --}}
                <li class="aiz-side-nav-item">
                    <a href="{{route('blog.index')}}" class="aiz-side-nav-link">
                    <i class="las la-bolt aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{trans('all.Blogs')}}</span>
                    </a>
                </li>
                {{-- Create Blogs --}}
                <li class="aiz-side-nav-item">
                    <a href="{{route('blog.create')}}" class="aiz-side-nav-link">
                    <i class="las la-bolt aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{trans('all.Add Blog')}}</span>
                    </a>
                </li>
                {{-- Pages SEO --}}
                <li class="aiz-side-nav-item">
                    <a href="{{route('seo.index')}}" class="aiz-side-nav-link">
                    <i class="las la-bolt aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{trans('all.Pages SEO')}}</span>
                    </a>
                </li>
                {{-- Configs --}}
                {{--  <li class="aiz-side-nav-item">
