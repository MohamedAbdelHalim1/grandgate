                            ...
                            <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <div class="form-group mb-3 lg-gutters-20 text-center">
                                            ...
                                            <textarea name="list" class="form-control" placeholder="separate by comma"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-1">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="form-group mb-3 lg-gutters-20 text-center">
                                            ...
                                            <textarea name="list_ar" class="form-control" placeholder="separate by comma"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr size:5px>
                                ...
                                <div class="form-group mb-3 lg-gutters-25 text-center">
                                    ...
                                    <select name="category_id" class="form-control"
                                        placeholder="{{ trans('all.select_product') }}" required>
                                        <option value="">{{ trans('all.choose_product') }}</option>
