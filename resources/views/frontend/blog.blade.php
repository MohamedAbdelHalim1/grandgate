                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link rounded-1" aria-current="page" href="{{ route('about-us', $lang) }}">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active rounded-1" href="{{ route('blog', $lang) }}">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 mb-4 rounded-0">
                    <div class="card rounded-0">
                        <div style="height: 220px;">
                            <a href="{{ route('blog_details', ['lang' => $lang, 'id' => $post->id]) }}"><img
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="my-auto">
                                    <a href="{{ route('blog_details', ['lang' => $lang, 'id' => $post->id]) }}">
