        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8 header-content text-center mx-auto">
                ...
                <p class="d-inline-flex gap-1 mt-xl-4 mt-lg-4 mt-md-4">
                    <a href="{{ route('projects', $lang) }}" class="btn button rounded-0 p-xl-3 p-lg-3 p-md-3">Our
                        Projects</a>
                    <a href="{{ route('contact-us', $lang) }}"
                        ...
                        <div class="row justify-content-center">
                            @foreach ($products1 as $key => $product)
                                <div class="col-xl-3 col-lg-3 col-md-3 mb-2 rounded-0">
                                    <div class="card">
                                        <a
                                            href="{{ route('product_details', ['lang' => $lang, 'slug' => $product->slug]) }}">
                                            <div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    ...
                                                    <p>{{ Str::limit($blog->description, 50) }}</p> <!-- Short blog description -->
                                                    </div>
                                                <div class="my-auto">
                                                    <a href="{{ route('blog_details', ['lang' => $lang, 'id' => $blog->id]) }}">
                                                        <div class="p-1 circle">
            ...
            <div id="buttons">
                ...
                @foreach ($categories as $key => $category)
                    <button class="button3"
                        onclick="filterSelection('{{ $category->name }}')">{{ $category->name }}</button>
                @endforeach
            </div>
                    ...
                    <div class="column-proj ">
                        <div class="content">
                            <a href="{{ route('project_details', ['lang' => $lang, 'slug' => $project->slug]) }}">
                                <img src="{{ asset($project->cover) }}" style="width:100%;">
                            </a>
                            <h4>{{ $project->name }}</h4>
                        </div>
                    </div>
