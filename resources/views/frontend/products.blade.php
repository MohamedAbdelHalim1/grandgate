            ...
            <div class="d-flex justify-content-center">
                <div style="width: 180px; ">
                    <div class="mx-auto image-logo">
                        <img src="{{ asset('assets_front/images/accessories/logoMotor/53.png') }}"
                            style="width: 100%;" alt="...">
                    </div>
                </div>
                <div style="width: 180px; ">
            ...
            <div class="row justify-content-center">
                @foreach ($categories as $category)
                    <div class="col-xl-4 col-lg-4 mb-3">
                        <a href="{{ route('product_details', ['lang' => $lang, 'slug' => $category->slug]) }}">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-6 my-auto mx-auto">
                    ...
                    <div>
                        <a href="{{ route('accessories', $lang) }}" class="btn button rounded-0 p-3">Our
                            Accessories</a>
                    </div>
                </div>
