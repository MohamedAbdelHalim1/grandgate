    ...
    <header class="header-image " oncontextmenu="return false;" oncopy="return false;" onpaste="return false;"
        ...
        <div class="d-flex justify-content-between header-content rtl">
            ...
            <div class="breadcrumbs">
                ...
                <span> / </span>
                <a href="{{ route('products', $lang) }}">الملحقات و المحركات</a>
                <span> / </span>
                <span style="color: #eb242c;">{{ $accessory->name_ar }}</span>
            </div>
        </div>
    ...
    <section class="accessoriesDetails text-center mt-xl-5 mt-lg-5 mt-md-5 mb-5" oncontextmenu="return false;"
        ...
        <div class="row justify-content-center rtl" id="one">
            <div class="col-xl-5 col-lg-6 col-md-8 my-auto mx-auto">
                <h3>{{ $accessory->title_ar }}</h3>
                <p>{{ $accessory->description_ar }}</p>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 my-auto mx-auto">
                <img src="{{ asset($accessory->image) }}" style="width: 100%;">
            </div>
        </div>
    </section>
