...
<head>
    ...
    <title>{{ $seoMeta->title ?? 'Default Title' }} - {{ $project->name }}</title>
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('projects', $lang) }}">Projects</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center box">
                <div class="col-xl-4 col-lg-4 col-md-4">
                    ...
                    @endphp
                    @if ($project->list && $project->list != '' && $project->list != ' ')
                        <ul>
                            @foreach ($list as $li)
                                <li class="mb-1">
                                    {{ $li }}
