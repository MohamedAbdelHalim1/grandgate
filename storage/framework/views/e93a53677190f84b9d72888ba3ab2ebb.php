...
<head>
    ...
    <title><?php echo e($seoMeta->title ?? 'Default Title'); ?> - <?php echo e($project->name_ar); ?></title>
...
<body>
    ...
    <header class="header-image " oncontextmenu="return false;" oncopy="return false;" onpaste="return false;"
        ...
        <div class="d-flex justify-content-between header-content rtl">
            <div>
                <h1><?php echo e($project->name_ar); ?></h1>
            </div>
            <div class="breadcrumbs">
                ...
                <span> / </span>
                <span style="color: #eb242c;"><?php echo e($project->name_ar); ?></span>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center box">
                <div class="col-xl-5 col-lg-5 col-md-5">
                    <h2><?php echo e($project->name_ar); ?></h2>
                    ...
                    ?>
                    <?php if($project->list_ar && $project->list_ar != '' && $project->list_ar != ' '): ?>
                        <ul>
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/project-detailsAr.blade.php ENDPATH**/ ?>