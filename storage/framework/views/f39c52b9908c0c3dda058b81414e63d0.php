...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets_front/css/products.css')); ?>">
...
<body>
    ...
    <section class="logoMotor bg-secondary bg-opacity-10 p-5" oncontextmenu="return false;" oncopy="return false;"
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <h2>Our commitment to quality aligns perfectly with <br> the world's most esteemed brands</h2>
                <div class="line"></div>
            </div>
    ...
    <!---->
    <section class="products mt-xl-5 mt-lg-5 mt-md-5 mb-xl-5 mb-lg-5 mb-md-5" oncontextmenu="return false;"
            ...
            <div class="row justify-content-center">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-4 col-lg-4 mb-3">
                        <a href="<?php echo e(route('product_details', ['lang' => $lang, 'slug' => $category->slug])); ?>">
                            <div class="products-section">
                                <img src="<?php echo e(asset($category->cover ?: $category->images->first()->url)); ?>"
                                    class="image">
    ...
    <!---->
    <section class="accessories-sec mt-xl-5 mt-lg-5 mt-md-5 mb-xl-5 mb-lg-5 mb-md-5" oncontextmenu="return false;"
        oncopy="return false;" onpaste="return false;" oncut="return false;" onmousedown="return false;"
        onselectstart="return false;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-6 my-auto mx-auto">
                    ...
                    <div>
                        <a href="<?php echo e(route('accessories', $lang)); ?>" class="btn button rounded-0 p-3">Our
                            Accessories</a>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-5 my-auto mx-auto mt-3">
                    <img src="<?php echo e(asset('assets_front/images/accessories/accessories-and-motors.jpg')); ?>"
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/products.blade.php ENDPATH**/ ?>