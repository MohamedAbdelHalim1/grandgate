            ...
            <div class="d-flex justify-content-center">
                <div style="width: 180px;">
                    <div class="mx-auto image-logo">
                        <img src="<?php echo e(asset('assets_front/images/accessories/logoMotor/53.png')); ?>" style="width: 100%;"
                            alt="...">
                    </div>
                </div>
                <div style="width: 180px;">
            ...
            <div class="row justify-content-center">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-4 col-lg-4 mb-3">
                        <a href="<?php echo e(route('product_details', ['lang' => $lang, 'slug' => $category->slug_ar])); ?>">
                            <div class="products-section">
                                <img src="<?php echo e(asset($category->cover ?: $category->images->first()->url)); ?>"
                                    class="image">
                                <div class="overlay-product">
                                    <div class="text">
                                        <h4><?php echo e($category->name_ar); ?></h4>
                                        <p><?php echo e($category->title_ar); ?></p>
                                    </div>
                                </div>
                            </div>
                        </a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-6 my-auto mx-auto">
                    ...
                    <div>
                        <a href="<?php echo e(route('accessories', $lang)); ?>" class="btn button rounded-0 p-3">الملحقات</a>
                    </div>
                </div>
    ...
    <footer>
        ...
        <div class="d-flex justify-content-between text-center small-footer rtl">
            <div class="mx-auto my-auto" style="width: 33%;">
                <img src="<?php echo e(asset('assets_front/images/accessories/logo.png')); ?>">
            </div>
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/productsAr.blade.php ENDPATH**/ ?>