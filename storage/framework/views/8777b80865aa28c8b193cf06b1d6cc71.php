        ...
        <div class="row rtl">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8 header-content text-center mx-auto">
                ...
                <p class="d-inline-flex gap-1 mt-xl-4 mt-lg-4 mt-md-4">
                    ...
                    <a href="<?php echo e(route('contact-us', $lang)); ?>" class="btn button2 rounded-0 p-xl-3 p-lg-3 p-md-3">تواصل
                        معنا</a>
                            ...
                            <div class="row justify-content-center">
                                <?php $__currentLoopData = $products1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-xl-3 col-lg-3 col-md-3 mb-2 rounded-0">
                                        <div class="card">
                                            <a
                                                href="<?php echo e(route('product_details', ['lang' => $lang, 'slug' => $product->slug_ar])); ?>">
                                                <div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <h5 class="card-title"><?php echo e($product->name_ar); ?></h5>
                                                        <p><?php echo e($product->title_ar); ?></p>
                                                    </div>
                                                    <div class="my-auto">
                                                        <a
                                                            href="<?php echo e(route('product_details', ['lang' => $lang, 'slug' => $product->slug_ar])); ?>">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 mb-2 rounded-0">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h5 class="card-title"><?php echo e($blog->title_ar); ?></h5>
                                                    <p><?php echo e(Str::limit($blog->description_ar, 50)); ?></p> <!-- Short blog description -->
                                                    </div>
                                                <div class="my-auto">
                                                    <a href="<?php echo e(route('blog_details', ['lang' => $lang, 'id' => $blog->id])); ?>">
                                                        <div class="p-1 circle">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h5 class="card-title"><?php echo e($blog->title_ar); ?></h5>
                                                    <p><?php echo e(Str::limit($blog->description_ar, 50)); ?></p>
                                                </div>
                                                <div class="my-auto">
                                                    <a href="<?php echo e(route('blog_details', ['lang' => $lang, 'id' => $blog->id])); ?>">
                                                        <div class="p-1 circle">
            ...
            <div id="buttons">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="button3"
                        onclick="filterSelection('<?php echo e($category->name); ?>')"><?php echo e($category->name_ar); ?></button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                    ...
                    <div class="column-proj ">
                        <div class="content">
                            <a href="<?php echo e(route('project_details', ['lang' => $lang, 'slug' => $project->slug_ar])); ?>">
                                <img src="<?php echo e(asset($project->cover)); ?>" style="width:285px; height:233px;">
                            </a>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="column-proj  <?php echo e($category->name); ?>">
                            <div class="content">
                                <a
                                    href="<?php echo e(route('project_details', ['lang' => $lang, 'slug' => $project->slug_ar])); ?>">
                                    <img src="<?php echo e(asset($project->cover)); ?>" style="width:285px; height:233px;">
                                </a>
                                <h4><?php echo e($project->name_ar); ?></h4>
                            </div>
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/indexAr.blade.php ENDPATH**/ ?>