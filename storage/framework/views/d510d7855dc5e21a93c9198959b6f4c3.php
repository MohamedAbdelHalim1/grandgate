            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('products', $lang)); ?>">Accessories &
                                Motors</a></li>
    ...
    <section class="accessoriesDetails text-center mt-xl-5 mt-lg-5 mt-md-5 mb-5" oncontextmenu="return false;"
        ...
        <div class="row justify-content-center rtl" id="one">
            <div class="col-xl-5 col-lg-6 col-md-8 my-auto mx-auto">
                <h3><?php echo e($accessory->title); ?></h3>
                <p><?php echo e($accessory->description); ?></p>
            </div>
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/accessories_details.blade.php ENDPATH**/ ?>