...
<head>
    ...
    <title><?php echo e($seoMeta->title ?? 'Default Title'); ?> - <?php echo e($project->name); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets_front/css/project-details.css')); ?>">
...
<body>
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('projects', $lang)); ?>">Projects</a></li>
    ...
    <!---->
    <section class="project-details mt-xl-5 mt-lg-5 mt-md-5 mb-xl-5 mb-lg-5 mb-md-5" oncontextmenu="return false;"
        ...
        <div class="container">
            <div class="row justify-content-center box">
                <div class="col-xl-4 col-lg-4 col-md-4">
                    ...
                    <?php
                        if ($project->list) {
                            $list = explode(',', $project->list);
                        }
                    ?>
                    <?php if($project->list && $project->list != '' && $project->list != ' '): ?>
                        <ul>
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/project-details.blade.php ENDPATH**/ ?>