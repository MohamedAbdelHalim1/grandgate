...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets_front/css/projects.css')); ?>">
...
<body>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link rounded-1" href="<?php echo e(route('projects', $lang)); ?>">
                                    <span style="color: #eb242c;">PROJECTS</span>
                                </a>
                            </li>
                            <li class="nav-item ">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="color: #eb242c;">Projects</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <!---->
    <section class="projects mt-xl-5 mt-lg-5 mt-md-5 mb-xl-5 mb-lg-5 mb-md-5" oncontextmenu="return false;"
...
<?php /**PATH /home/1216096.cloudwaysapps.com/ncaabhugrv/public_html/resources/views/frontend/projects.blade.php ENDPATH**/ ?>